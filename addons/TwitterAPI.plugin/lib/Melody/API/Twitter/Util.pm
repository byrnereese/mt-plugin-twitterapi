...
our @EXPORT_OK = qw( serialize_author twitter_date truncate_tweet serialize_entries is_number );
...
sub serialize_entries {
    ...
    foreach my $e (@$entries) {
        ...
        push @$statuses, {
                ...
                id => $e->id,
                text => $txt,
                source => 'Melody', # TODO - replace with a meta data field I should create
